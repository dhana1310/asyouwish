...
<body class="animsition">
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url(images/contact_us_1400_239.jpg);">
			...
			<div class="row">
				<div class="col-md-6 p-b-30">
					<div class="p-r-20 p-r-0-lg">
						<div class="contact-map size21" id="google_map" data-map-x="22.5346185" data-map-y="88.3772015" data-pin="images/icons/asyouwish-position-map.png" data-scrollwhell="0" data-draggable="1"></div>
					</div>
				</div>
